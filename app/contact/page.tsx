      ...
      <section className="bg-blue-50 py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-center max-w-3xl mx-auto">
            We're here to help. Reach out to us with any questions or to schedule a service.
          </p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">infohireprow@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Monday - Sunday: 24/7 Service</p>
                    <p className="text-gray-600">Office Hours: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
              </div>
